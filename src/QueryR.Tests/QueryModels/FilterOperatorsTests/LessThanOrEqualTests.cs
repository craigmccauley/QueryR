...
{
    [Theory, AutoSubData]
    public void LessThanOrEqual_ShouldWorkOnValueTypes(
        List<int> values)
    {
        //arrange
        ...
        var whereExpression = Expression.Lambda<Func<int, bool>>(FilterOperators.LessThanOrEqual.ExpressionMethod(parameter, constant), parameter);
    ...
    [Theory, AutoSubData]
    public void LessThanOrEqual_ShouldWorkOnDateTime(
        List<DateTime> values)
    {
        ...
        var constant = Expression.Constant(valueToCompare);
        var whereExpression = Expression.Lambda<Func<DateTime, bool>>(FilterOperators.LessThanOrEqual.ExpressionMethod(parameter, constant), parameter);
